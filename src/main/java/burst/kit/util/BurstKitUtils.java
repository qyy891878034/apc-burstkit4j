...
public final class BurstKitUtils {
    ...
    private static final AtomicReference<String> addressPrefix = new AtomicReference<>("APC");
    private static final AtomicReference<String> valueSuffix = new AtomicReference<>("APC");
